use super::mmacro::{__static_funk, static_funk, static_vec_string_funk};
...
pub fn get_XIU(month: i64, day: i64) -> String {
    XIU_27()[((XIU_OFFSET()[month as usize - 1] + day - 1) % XIU_27().len() as i64) as usize]
        .to_string()
}
...
static_vec_string_funk!(
    DAY_ZHAI_GUAN_YIN,
    [
        "1-8", "2-7", "2-9", "2-19", "3-3", "3-6", "3-13", "4-22", "5-3", "5-17", "6-16", "6-18",
        "6-19", "6-23", "7-13", "8-16", "9-19", "9-23", "10-2", "11-19", "11-24", "12-25"
    ]
);
...
__static_funk!(
    ...
    Vec<String>,
    [
        "1-1", "1-3", "1-5", "1-6", "1-7", "1-8", "1-9", "1-13", "1-14", "1-15", "1-16", "1-19",
        "1-23", "1-25", "1-27", "1-28", "1-29", "1-30", "2-1", "2-2", "2-3", "2-6", "2-8", "2-11",
        "2-14", "2-15", "2-17", "2-18", "2-19", "2-21", "2-23", "2-25", "2-27", "2-28", "2-29",
        "2-30", "3-1", "3-3", "3-6", "3-8", "3-9", "3-12", "3-14", "3-15", "3-16", "3-19", "3-20",
        "3-23", "3-25", "3-27", "3-28", "3-29", "3-30", "4-1", "4-3", "4-4", "4-6", "4-7", "4-8",
        "4-14", "4-15", "4-16", "4-17", "4-18", "4-20", "4-23", "4-25", "4-27", "4-28", "4-29",
        "4-30", "5-1", "5-3", "5-5", "5-6", "5-7", "5-8", "5-11", "5-12", "5-13", "5-14", "5-15",
        "5-16", "5-17", "5-18", "5-22", "5-23", "5-25", "5-26", "5-27", "5-28", "5-29", "5-30",
        "6-1", "6-3", "6-5", "6-6", "6-8", "6-10", "6-14", "6-15", "6-19", "6-23", "6-24", "6-25",
        "6-27", "6-28", "6-29", "6-30", "7-1", "7-3", "7-5", "7-6", "7-7", "7-8", "7-10", "7-12",
        "7-13", "7-14", "7-15", "7-16", "7-18", "7-19", "7-22", "7-23", "7-25", "7-27", "7-28",
        "7-29", "7-30", "8-1", "8-3", "8-5", "8-6", "8-8", "8-10", "8-12", "8-14", "8-15", "8-16",
        "8-18", "8-23", "8-24", "8-25", "8-27", "8-28", "8-29", "8-30", "9-1", "9-3", "9-6", "9-8",
        "9-9", "9-10", "9-11", "9-13", "9-14", "9-15", "9-17", "9-19", "9-23", "9-25", "9-27",
        "9-28", "9-29", "9-30", "10-1", "10-3", "10-5", "10-6", "10-8", "10-10", "10-11", "10-14",
        "10-15", "10-16", "10-23", "10-25", "10-27", "10-28", "10-29", "10-30", "11-1", "11-3",
        "11-4", "11-6", "11-8", "11-11", "11-14", "11-15", "11-17", "11-19", "11-21", "11-23",
        "11-25", "11-26", "11-27", "11-28", "11-29", "11-30", "12-1", "12-3", "12-6", "12-7",
        "12-8", "12-12", "12-14", "12-15", "12-16", "12-19", "12-20", "12-21", "12-23", "12-24",
        "12-25", "12-27", "12-28", "12-29", "12-30"
    ]
    .iter()
    .map(|c| c.to_string())
    .collect::<Vec<_>>()
...
__static_funk!(__FESTIVAL_VAL, Vec<Vec<FotoFestivalRef>>, {
    ...
    #[allow(non_snake_case)]
    let __R = FotoFestival::new_4("人神在阴", "犯者得病", true, "宜先一日即戒");
    #[allow(non_snake_case)]
    let __M = FotoFestival::new_4("司命奏事", __JS, true, "如月小，即戒廿九");
    #[allow(non_snake_case)]
    let __HH = FotoFestival::new_4("月晦", __JS, true, "如月小，即戒廿九");
    ...
    vec![
        ...
        vec![
            ...
            FotoFestival::new_4("北斗九星降世", __DJ, false, "此九日俱宜斋戒"),
        ],
