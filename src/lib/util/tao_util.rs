...
__static_funk!(
    ...
    Vec<String>,
    [
        "1-1", "1-3", "1-5", "1-7", "1-9", "1-13", "1-15", "1-19", "1-28", "2-1", "2-2", "2-3",
        "2-6", "2-13", "2-15", "2-19", "3-1", "3-3", "3-6", "3-15", "3-16", "3-18", "3-19", "3-20",
        "3-23", "3-26", "3-28", "4-1", "4-10", "4-14", "4-15", "4-18", "4-20", "4-28", "5-1",
        "5-5", "5-11", "5-13", "5-18", "5-20", "5-29", "6-1", "6-2", "6-3", "6-4", "6-5", "6-6",
        "6-10", "6-15", "6-19", "6-23", "6-24", "6-26", "7-7", "7-12", "7-15", "7-18", "7-20",
        "7-22", "7-26", "8-1", "8-3", "8-5", "8-10", "8-15", "9-1", "9-2", "9-3", "9-4", "9-5",
        "9-6", "9-7", "9-8", "9-9", "9-22", "9-23", "9-28", "10-1", "10-3", "10-6", "10-15",
        "10-18", "10-19", "10-20", "11-6", "11-9", "11-11", "11-26", "12-8", "12-16", "12-20",
        "12-21", "12-22", "12-23", "12-25", "12-29"
    ]
    .iter()
    .map(|c| c.to_string())
    .collect::<Vec<_>>()
...
__static_funk!(
    ...
    vec![
        ...
        vec![
            tao_festival::new_2("道德腊之辰", "道德腊，此日五帝会于西方七炁素天"),
            tao_festival::new_2("庆生中会", "此日中元赦罪，地官同天水二官考校罪福")
        ],
        ...
        vec![
            tao_festival::new_2("民岁腊之辰", "民岁腊，此日五帝会于北方五炁黑天"),
        ...
        vec![
            ...
            tao_festival::new_2("建生大会", "此日下元解厄，水官同天地二官考校罪福")
        ],
