use super::Lunar;
use crate::{
    eight_char::EightCharRef, foto::FotoRef, fu::FuRef, jie_qi::JieQiRef, lunar_time::LunarTimeRef,
    nine_star::NineStarRef, shu_jiu::ShuJiuRef, solar::SolarRef, tao::TaoRef,
};
use std::{
    collections::HashMap,
    sync::{Arc, Mutex},
