...
#[test]
fn foto_test3_from_ymd() {
    let a = foto::from_ymd(2565, 10, 14);
    let b = foto::from_lunar(lunar::from_ymd(2021, 10, 14));
    assert_eq!(a.to_full_string(), b.to_full_string());
}
