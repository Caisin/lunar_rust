...
fn lunar_test26_1() {
    ...
    for i in -1..1 {
        assert_eq!(
            solar.next(i, None).get_lunar().to_full_string(),
            lunar.next(i).to_full_string()
        )
    }
}
...
fn lunar_test57() {
    assert_eq!(
        "1582-10-04",
        lunar::from_ymd(1582, 9, 18).get_solar().to_ymd()
    );
}
...
fn lunar_test58() {
    assert_eq!(
        "1582-10-15",
        lunar::from_ymd(1582, 9, 19).get_solar().to_ymd()
    );
}
...
fn lunar_test59() {
    assert_eq!(
        "1518-02-10",
        lunar::from_ymd(1518, 1, 1).get_solar().to_ymd()
    );
}
...
fn lunar_test60() {
    assert_eq!(
        "0793-02-15",
        lunar::from_ymd(793, 1, 1).get_solar().to_ymd()
    );
}
#[test]
fn lunar_test61() {
    assert_eq!(
        "2025-07-25",
        lunar::from_ymd(2025, -6, 1).get_solar().to_ymd()
    );
}
#[test]
fn lunar_test62() {
...
fn lunar_test63() {
    assert_eq!(
        "0193-02-19",
        lunar::from_ymd(193, 1, 1).get_solar().to_ymd()
    );
}
#[test]
fn lunar_test64() {
...
fn lunar_test65() {
    assert_eq!(
        "0554-02-18",
        lunar::from_ymd(554, 1, 1).get_solar().to_ymd()
    );
}
#[test]
fn lunar_test66() {
    assert_eq!(
        "1070-02-14",
        lunar::from_ymd(1070, 1, 1).get_solar().to_ymd()
    );
}
#[test]
fn lunar_test67() {
    assert_eq!(
        "1537-02-10",
        lunar::from_ymd(1537, 1, 1).get_solar().to_ymd()
    );
}
#[test]
fn lunar_test68() {
    assert_eq!(
        "九一七年闰十月十四",
        solar::from_ymd(917, 12, 1).get_lunar().to_string()
    );
}
#[test]
fn lunar_test69() {
    assert_eq!(
        "九一七年冬月十五",
        solar::from_ymd(917, 12, 31).get_lunar().to_string()
    );
}
#[test]
fn lunar_test70() {
    assert_eq!(
        "九一七年冬月十六",
        solar::from_ymd(918, 1, 1).get_lunar().to_string()
    );
}
